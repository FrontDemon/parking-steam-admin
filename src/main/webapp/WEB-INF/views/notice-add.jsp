...
<body>
	<article class="page-container">
		<form class="form form-horizontal" id="form-notice-add" action="${APP_PATH}/infoManagement/addAnnouncement" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="context" class="textarea"  placeholder="请输入具体内容。。。" ></textarea>
				</div>
			</div>
		<div class="row cl">
