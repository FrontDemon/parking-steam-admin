...
<link rel="stylesheet" type="text/css" 
    href="${APP_PATH}/static/css/commentList.css"/>
<!--[if IE 6]>
...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd style="display: block">
				<ul>
					<li class="current"><a href="${APP_PATH}/CommentManagement/commentList" title="留言列表">留言列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-admin">
	...
	<i class="Hui-iconfont"></i> <a href="${APP_PATH}/adminIndex" class="maincolor">首页</a> <span
		class="c-999 en">&gt;</span>
	<span class="c-666">投诉建议管理</span> <span class="c-999 en">&gt;</span>
	<span class="c-666">留言列表</span> <a class="btn btn-success radius r"
	...
	<div class="Hui-article">
		...
		<div style="text-align: center">
			<input class="input-text radius" style="width: 200px" type="text" placeholder="输入留言"  id="searchinfo"/>
			<button class="btn btn-default" id="btn-search">
				<i class="Hui-iconfont"></i> 搜索留言
			</button>
		</div>
		...
		<table class="table table-border table-bordered table-hover table-bg">
			<caption class="bg-1" style="height: 40px;line-height: 40px;">留言列表</caption>
			<thead>
				<tr>
					<th>序号</th>
					<th>留言内容</th>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript" src="${APP_PATH}/static/js/commentList.js"></script>
	<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>