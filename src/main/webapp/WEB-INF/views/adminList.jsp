...
<link rel="stylesheet" type="text/css" 
    href="${APP_PATH}/static/css/adminList.css"/>
<!--[if IE 6]>
...
<body>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-admin">
			...
			<dd style="display: block">
				<ul>
					<li class="current"><a href="${APP_PATH}/systemManagement/adminList" title="管理员列表">管理员列表</a></li>
	...
	<div class="Hui-article">
		...
		<div style="text-align: center">
			<input class="input-text radius" style="width: 200px" type="text" id="searchinfo" placeholder="输入管理员名称" />
			<button class="btn btn-default" id="btn-search">
				<i class="Hui-iconfont"></i> 搜索管理员
			</button>
		</div>
		<div class="bg-1" style="margin-top: 20px; padding: 10px">
			<button class="btn btn-secondary radius" id="btn-add">
			<i class="Hui-iconfont">&#xe600;</i>添加管理员
			</button>
			<p class="show-count">
				共有数据：<span id="count"></span>&nbsp;条
			</p>
		</div>
		<table class="table table-border table-bordered table-hover table-bg">
			<caption class="bg-1" style="height: 40px;line-height: 40px;">管理员列表</caption>
			<thead>
				<tr>
					<th>序号</th>
					<th>账号</th>
...
<div id="modal-demo" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content radius">
			...
			<div class="modal-body">
				<p>
				<label for="add-account"><i>*</i>账号：</label>
				<input class="input-text radius" type="text" id="add-account" placeholder="用户名"/>
				</p>
				<p>
				<label for="add-psw"><i>*</i>密码：</label>
				<input class="input-text radius" type="password" id="add-psw" placeholder="密码"/>
				</p> 
				<p>
				<label for="confirm-psw"><i>*</i>确认密码：</label>
				<input class="input-text radius" type="password" id="confirm-psw" placeholder="确认密码"/>
				</p>
				<p>
				<label for="add-name"><i>*</i>管理员名称：</label>
				<input class="input-text radius" type="text" id="add-name" placeholder="管理员名称"/>
				</p>
			</div>
			<div class="modal-footer">
				<button class="btn btn-primary" id="btn-confirm">确定</button>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript" src="${APP_PATH}/static/js/adminList.js"></script>
	<!--请在上方写此页面业务相关的脚本-->
</body>
</html>