...
<link rel="stylesheet" type="text/css" 
    href="${APP_PATH}/static/css/pointRanking.css"/>
<!--[if IE 6]>
...
<body>
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover"><a href="#"
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="${APP_PATH}/adminSwitch">退出</a></li>
					</ul></li>
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-comments">
			...
			<dd style="display: block">
				<ul>
					<li class="current"><a href="${APP_PATH}/PointManagement/pointRanking" title="积分排行">积分排行</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-member">
	...
	<i class="Hui-iconfont"></i> <a href="${APP_PATH}/adminIndex" class="maincolor">首页</a> <span
		class="c-999 en">&gt;</span>
	<span class="c-666">积分管理</span> <span class="c-999 en">&gt;</span>
	<span class="c-666">积分排行</span> <a class="btn btn-success radius r"
	...
	<div class="Hui-article">
		...
		<div style="text-align: center">
			<input class="input-text radius" id="searchinfo" style="width: 200px"
				type="text" placeholder="输入用户名称" />
		...
		<table class="table table-border table-bordered table-hover table-bg">
			<caption class="bg-1" style="height: 40px;line-height: 40px;">积分排行榜</caption>
			<thead>
				<tr>
					<th>序号</th>
					<th>用户名称</th>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript" src="${APP_PATH}/static/js/pointRanking.js"></script>
	<!--/请在上方写此页面业务相关的脚本-->
</body>
</html>